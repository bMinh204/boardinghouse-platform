...
Ứng dụng không cung cấp tài khoản Admin mặc định. Trước lần khởi động đầu tiên, đặt:

```powershell
$env:APP_BOOTSTRAP_ADMIN_EMAIL="admin@example.com"
$env:APP_BOOTSTRAP_ADMIN_PASSWORD="mat-khau-manh-toi-thieu-12-ky-tu"
```

Tài khoản chỉ được tạo nếu email chưa tồn tại. Ứng dụng không đặt lại mật khẩu
hoặc nâng quyền tài khoản đã tồn tại. Sau khi tạo thành công, hãy xóa hai biến
môi trường bootstrap.
